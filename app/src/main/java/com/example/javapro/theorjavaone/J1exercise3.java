...
public class J1exercise3 extends AppCompatActivity {
    TextView tv;
    ...
    String questions[] = {
            ...
            "If i = 5 and we print \nSystem.out.print(i++);\nthe output is ? " ,
            "To ask user about his age after declaring Scanner sc = new Scanner ?" ,
            "To identify and fix syntax errors called ?"
    };
    String answers[] = {"reminder","5","int age = sc.nextInt();","debugging"};
    String options[] = {
            "assignment" , "reminder" , "addition" ,
            "6" , "5" , "4" ,
            "int age = input.nextInt();" , "int age = sc.nextint();" , "int age = sc.nextInt();" ,
            "debugging" , "tracing" , "troubleshooting"
    };
    int q=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_j1exercise3);
