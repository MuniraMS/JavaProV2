...
public class J1exercise8 extends AppCompatActivity {
    TextView tv;
    Button submitbutton, quitbutton;
    RadioGroup radio_g;
    RadioButton rb1,rb2,rb3;
    String questions[] = {
           "A _____ can be used to initialize an object of a class when an object is created"
    };
    String answers[] = {"constructor"};
    String options[] = {
           "set" , "get" , "constructor"
    };
    int q=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_j1exercise8);
