...
public class j2exercise2 extends AppCompatActivity {
    TextView tv;
    Button submitbutton, quitbutton;
    RadioGroup radio_g;
    RadioButton rb1,rb2,rb3;
    String questions[] = { "Every class must have at least one constructor ?",
            " If you have at least one constructor, the compiler will  create a default constructor?"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_j2exercise2);
