...
public class j2exercise1 extends AppCompatActivity {
    TextView tv;
    Button submitbutton, quitbutton;
    RadioGroup radio_g;
    RadioButton rb1,rb2,rb3;
    String questions[] = { "what is an object ?",
            "which method allow objects to change data ?",
            "privet is clint’s view of the services provided by the class?",
            "which of the following is the default value of an instance variable?"
    };
    String answers[] = {"all","set()","false"," depends upon the type of variable"};
    String options[] = {
            "an object is a class instance" , "an object can be an array " , "all",
            "get()" , "add()" , "set()",
            "true", "false"," - ",
            "null" , "0", " depends upon the type of variable"};
    int q=0;
    public static int correct=0,wrong=0,sum=0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_j2exercise1);
