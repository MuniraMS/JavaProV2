...
public class j2exercise3 extends AppCompatActivity {
    TextView tv;
    Button submitbutton, quitbutton;
    RadioGroup radio_g;
    RadioButton rb1,rb2,rb3;
    String questions[] = { "Method overriding is combination of inheritance and polymorphism? ",
            "A class can have references to objects of other classes as members this is called composition? ", " which of examples are expression about the composition?"
    };
    String answers[] = {"true","true","computer-processor"};
    String options[] = {
            "true"," false " , " -" ,
            "true"," false " , " -",
            "BankAccount-Customer","computer-processor"
            ,"car-owner"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_j2exercise3);
